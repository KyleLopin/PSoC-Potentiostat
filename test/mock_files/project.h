...
int ADC_SigDel_SelectConfiguration(uint16_t foo, uint16_t bar) {return 1;}
...
int ADC_SigDel_SetBufferGain(uint16_t foo) {return 1;}
...
int AMux_TIA_resistor_bypass_Connect(uint16_t foo) {return 1;}
int AMux_TIA_resistor_bypass_Disconnect(uint16_t foo) {return 1;}
int AMux_TIA_resistor_bypass_Select(uint16_t foo) {return 1;}
...
int EEPROM_ReadByte(uint16_t foo) {return 1;}
...
int TIA_SetResFB(uint16_t foo) {return 1;}
