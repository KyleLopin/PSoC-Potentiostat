...
int AMux_electrode_Select() {return 1;}
...
int AMux_TIA_resistor_bypass_Disconnect() {return 1;}
int PWM_isr_WriteCounter() {return 1;}
void DAC_Sleep(void){}
...
int AMux_TIA_resistor_bypass_Connect() {return 1;}
int TIA_Sleep() {return 1;}
int ADC_SigDel_SelectConfiguration() {return 1;}
int CyDelayUs() {return 1;}
...
int AMux_TIA_input_Select() {return 1;}
...
int PWM_isr_WritePeriod() {return 1;}
